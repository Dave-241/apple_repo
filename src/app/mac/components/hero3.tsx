...
const Hero_3 = () => {
  return (
    <>
      <div className="w-full h-[700px] sm:h-[470px] bg-black mac_hero3_bg mt-[15px] flex justify-center pt-[40px] ">
        <div className="flex-col flex gap-[8px] items-center text-white">
          <p className="text-[darkorange] text-[14px] font-[700]">NEW</p>
          <h1 className="text-[48px] font-[700] sm:text-[40px]">Mac mini</h1>
          <h3 className="text-[24px] sm:text-[21px] font-[700]">
            More muscle. More hustle.
          </h3>
          <p className="text-[17px] pt-[20px] sm:pt-0">From $599</p>
