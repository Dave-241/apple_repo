...
const Hero_6 = () => {
  ...
  const wrap1: any = [
    {
      img: "EDUCATION",
      background: "/store/store_hero5_1.png",
      text: "Save on Mac or iPad with education pricing.",
      color: "black",
      sup: "1",
    },
    {
      img: "BUSINESS",
      background: "/store/store_hero5_2.png",
      text: "From enterprise to small business, we will work with you",
      color: "white",
      sup: "1",
    },
    ...
    {
      img: "GOVERNMENT",
      background: "/store/store_hero5_3.png",
      text: "Special pricing is available for state, local, and federal agencies.",
      color: "white",
      sup: "1",
    },
    {
      img: "VERTERANS AND MILITARY",
      background: "/store/store_hero5_4.png",
      text: "Active and veteran members may be eligible for exlsusive savings.",
      color: "black",
      sup: "1",
    },
    {
      img: "CERTIFIED REFURBISHED",
      background: "/store/store_hero5_5.png",
      text: "Shop refurbished Apple products backed by a one-year warranty.",
      color: "black",
      sup: "",
    },
  ];
  ...
  const showctn = () => {
    translate == "800" ? setright("none") : setright("flex");
    ...
    <>
      <div className="w-full py-[20px] sm:py-[10px] flex justify-center  bg-[#F3F5F7] text-[30px] sm:text-[25px] font-[700] pt-[80px] ">
        <p className="text-[gray] sm:w-[90%]  w-[70%]">
          <span className="text-black">Special stores. </span> Exclusive savings
          for businesses, school, and more.
        </p>
      </div>
      {/*  */}
            ...
            return (
              ...
              >
                <div className="store_hero2_img px-[20px] py-[20px] flex flex-col gap-[10px]">
                  <p className="uppercase text-[15px] text-gray-400 font-[700]">
                    {e.img}
                  </p>
        ...
        >
          {MainWrap.map((e: any, index: any) => {
            return (
              ...
              >
                <div className="store_hero2_img px-[20px] py-[20px] flex flex-col gap-[10px]">
                  <p className="uppercase font-[700] text-gray-400 text-[12px]     ">
                    {e.img}
                  </p>
                  <h1 className="capitalize text-[25px] font-[700]">
                    {e.text}
